...
struct User: Identifiable, Codable, Hashable {
    ...
    init(id: UUID = UUID(), name: String, email: String? = nil, password: String? = nil, paymentID: String? = nil, paymentType: String? = nil, bankBin: String? = nil, payOSClientId: String? = nil, payOSApiKey: String? = nil, payOSChecksumKey: String? = nil, avatarURL: String? = nil) {
        self.id = id
        self.name = name
        self.email = email
